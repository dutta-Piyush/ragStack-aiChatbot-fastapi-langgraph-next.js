...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "RagStack AI Chatbot")
        self.VERSION = os.getenv("VERSION", "1.0.0")
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "A RAGStack AI Chatbot built with FastAPI, LangGraph, and Langfuse for tracing."
        )
        ...
        self.SESSION_NAMING_LLM_MODEL = os.getenv("SESSION_NAMING_LLM_MODEL", "gpt-5-nano")
        self.SESSION_NAMING_ENABLED = os.getenv("SESSION_NAMING_ENABLED", "true").lower() == "true"
        self.DEFAULT_LLM_TEMPERATURE = float(os.getenv("DEFAULT_LLM_TEMPERATURE", "0.2"))
        self.MAX_COMPLETION_TOKENS = int(os.getenv("MAX_COMPLETION_TOKENS", os.getenv("MAX_TOKENS", "2000")))
